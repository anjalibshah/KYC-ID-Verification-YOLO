...
def predict(sess, image_file):
    ...
    image.save(os.path.join("static/outimage", image_file), quality=90)
    # Display the results in the notebook
   # output_image = imageio.imread(os.path.join("outimage", image_file))
    #imshow(output_image)
    
    return out_scores, out_boxes, out_classes

if __name__ == "__main__":
    predict(sess, "passport-photo-page.jpg")
